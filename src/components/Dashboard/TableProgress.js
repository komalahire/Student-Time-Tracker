...
const TableProgress = () => {
  const studentProgressData = [
    { student: 'John Doe', studentId: '12345', contentProgress: '90%', grades: "76/100", goal:"B+", performance: 'Great' },
    { student: 'John Doe', studentId: '12345', contentProgress: '90%', grades: "76/100", goal:"B+", performance: 'Great' },
    { student: 'John Doe', studentId: '12345', contentProgress: '90%', grades: "76/100", goal:"B+", performance: 'Great' },
    { student: 'John Doe', studentId: '12345', contentProgress: '90%', grades: "76/100", goal:"B+", performance: 'Great' },
    { student: 'John Doe', studentId: '12345', contentProgress: '90%', grades: "76/100", goal:"B+", performance: 'Great' },
        ...
        <TableBody>
          {studentProgressData.map((row, index) => (
            <TableRow key={index}>
              ...
              <TableCell><BorderLinearProgress variant="determinate" value={50} /> <br/>
              {"visited"+row.grades}</TableCell>
